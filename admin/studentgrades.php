					...
					<fieldset>
						...
						?>
				          ...
				          <div class="form-group">
				            <div class="col-md-8">
				              <label class="col-md-4 control-label" for=
				              "subjdesc">Nombre de asignatura</label>
						...
						<?php
						 ...
						 ?>
				           <div class="form-group">
				            <div class="col-md-8">
				              <label class="col-md-4 control-label" for=
				              "prelim">Preliminar</label>

				              <div class="col-md-8">
				                 <input class="form-control input-sm" id="prelim" name="Preliminar"   onkeyup="calculate()"  type="text" value="<?php echo (isset($cur)) ? $cur->PRE  : 'preliminar' ;?>">
				              </div>
				            </div>
				          </div>
				           <div class="form-group">
				            <div class="col-md-8">
				              <label class="col-md-4 control-label" for=
				              "midterm">Medio plazo</label>

				              <div class="col-md-8">
				                 <input class="form-control input-sm" id="midterm" name="midterm"  onkeyup="calculate()"    type="text" value="<?php echo (isset($cur)) ? $cur->MID  : 'medio plazo' ;?>">
				              </div>
				            </div>
				          </div>
				           <div class="form-group">
						 ...
						 <div class="form-group">
				            <div class="col-md-8">
				              ...
				              "idno"></label>
				              <div class="col-md-8">
				                <a href="instructorClasses.php?classId=<?php echo $_GET['classId']; ?>" class="btn btn-primary" name="savecourse" type="submit" >Regresar</a>

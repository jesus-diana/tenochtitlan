    		...
    		<table class="table" align="center" >	 
				  ...
				  <tbody>				    
			     	...
			     	<!--	<td><?php //echo (isset($cur)) ? $cur->SEMESTER : 'Semester' ;?></td>-->
			     		<strong>Grado:</strong> <?php echo (isset($cur)) ? $cur->COURSE_NAME : 'Course' ;?><br/>
			     	<!--	<td><?php //echo (isset($cur)) ? $cur->COURSE_LEVEL : 'Level' ;?></td>-->
			     		...
			     		<strong>Aula:</strong> <?php echo (isset($cur)) ? $cur->ROOM : 'Course' ;?><br/>
			     		<strong>Seccion:</strong> <?php echo (isset($cur)) ? $cur->SECTION : 'Course' ;?><br/>
			     	</td>

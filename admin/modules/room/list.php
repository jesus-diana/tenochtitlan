<?php
		...
		<div class="well">
			    ...
			    <form action="controller.php?action=delete" Method="POST">  
					<caption><h3 align="left">Lista de aulas</h3></caption>					
				...
				<div class="btn-group">
				  ...
				  <button type="submit" class="btn btn-default" name="delete"><span class="glyphicon glyphicon-trash"></span>Eliminar selescionado</button>
				</div>';
			}
				?>
				</form>

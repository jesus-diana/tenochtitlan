...
<form class="form-horizontal well span6" action="controller.php?action=edit&id=<?php echo $courseid;?>" method="POST">
	...
	<fieldset>
		<legend>Modificar grado</legend>
		<div class="form-group">
            <div class="col-md-8">
              <label class="col-md-4 control-label" for=
              "coursename">Grado </label>

              <div class="col-md-8">
                 <input class="form-control input-sm" id="coursename" name="coursename" placeholder=
									  "Codigo del curso" type="text" value="<?php echo $object->COURSE_NAME;?>">
              </div>
            </div>
          </div>
        <!--    <div class="form-group">
            <div class="col-md-8">
              ...
              <div class="col-md-8"> -->
                 <input class="form-control input-sm" id="level" name="level" placeholder=
									  "Curso" type="hidden" value="<?php echo $object->COURSE_LEVEL;?>">
             <!-- </div>
            </div>
          </div> -->
       <!--    <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-8">
              <label class="col-md-4 control-label" for=
              "coursedesc">Descripcion</label>

              <div class="col-md-8">
                 <input class="form-control input-sm" id="coursedesc" name="coursedesc" placeholder=
									  "Descripcion del Curso" type="text" value="<?php echo $object->COURSE_DESC;?>">
              </div>
            </div>
          </div>

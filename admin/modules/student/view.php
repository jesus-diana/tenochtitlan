...
<div class="well">
				...
				<table class="table table-hover">
					<caption><h3 align="left">Registros de Estudiantes inscritos </h3></caption>
				  <thead>
				  	<tr>
				  		<th> <input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');"> Grado y Seccion</th>
				  	<!--	<th>Semester</th>-->
				  		<th>Año escolar</th>
				  		<th>Estado</th>
				  		<th>Año de inscripcion</th>
				  		<th>Opciones</th>
				  ...
				  //		echo '<td>'. $schoolyr->SEMESTER.'</td>';
				  		...
				  		echo '<td><a href = "index.php?view=subject&studentId='.$schoolyr->IDNO.'&cid='.$schoolyr->COURSE_ID.'&sy='.$schoolyr->SYID.'">Materias registradas</a></td>';
				  		echo '</tr>';
				  	} 
				  	?>
				  </tbody>
			...
			echo   '<div class="btn-group">
				  <a href="index.php?view=enroll&studentId='. $_GET['studentId'].'" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span> Nuevo</a>

	...
	<caption><h3 align="left">Lista de curso</h3></caption>		
		<div class="well">
				...
				<div class="btn-group">
				  <a href="index.php?view=subject&studentId=<?php echo (isset($studentId)) ? $studentId : 'ID' ;?>&cid=<?php echo (isset($courseid)) ? $courseid : 'cid' ;?>&sy=<?php echo (isset($sy)) ? $sy : 'sy' ;?>" class="btn btn-default"><span class="glyphicon glyphicon-back"></span>Regresar</a>
				  <button type="submit" class="btn btn-default" name="Add"><span class="glyphicon glyphicon-plus-sign"></span>Asignar seleccionado</button>
				</div>
				</form>
	  	</div><!--End of well-->

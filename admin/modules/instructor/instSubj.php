...
<form class="form-horizontal span4" action="controller.php?action=delsubj" method="POST">
	<div class="panel panel-primary">
	  <div class="panel-heading">
	    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Instructor de asignatura </h3>
	  </div>
	  <div class="panel-body">
	   <div class="row" >	   
    	...
    	<form class="form-horizontal span4" action="" method="POST">
		    ...
		    <tbody>
		     	<tr>
		     		<td>
		     			<p>
				     		<b>Nombre completo : </b><?php echo (isset($cur)) ? $cur->INST_FULLNAME : 'Fullname' ;?><br/>
				     		<b>Sexo : </b><?php echo (isset($cur)) ? $cur->INST_SEX  : 'Sex' ;?><br/>
				     		<b>Estado de Empleo : </b><?php echo (isset($cur)) ? $cur->EMPLOYMENT_STATUS : 'EMPLOYMENT STATUS' ;?><br/>
				     		<b>Especializacion : </b><?php echo (isset($cur)) ? $cur->SPECIALIZATION : 'SPECIALIZATION' ;?><br/>
				     		<b>Direccion : </b><?php echo (isset($cur)) ? $cur->INST_ADDRESS : 'Address' ;?>
		...
		<br>
		<h3 align="left">Lista de Asignaturas</h3>
			    <table id="example" class="display" cellspacing="0" width="100%">
				  ...
				  <thead>
				  	<tr>
				  		<tr>
				  		<th width="10">No</th>	
				  		<th  width="20%" class="bottom"> <input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');">Asignatura</th>
	  		...
	  		<!--	<tfoot>
				...
				<div class="btn-group">
				  <a href="index.php" class="btn btn-default">Regresar</a>
				   <a href="index.php?view=assign&instructorId=<?php  echo (isset($_GET['instructorId'])) ? $_GET['instructorId']: 'ID' ; ?>" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>  Asignar asignaturas</a>

...
<div class="panel panel-primary">
	  <div class="panel-heading">
	    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Instructor de clases </h3>
	  </div>
	   ...
	   <div class="container">	
    	...
    	<form class="form-horizontal span4" action="" method="POST">
    		<table class="table" align="center" >	 
				  ...
				  <tbody>				    
			     	<tr>
			     		<td><strong>Codigo de asignatura:</strong> <?php echo (isset($cur)) ? $cur->SUBJ_CODE : 'Code' ;?><br/>
			     		<strong>Descripcion:</strong> <?php echo (isset($cur)) ? $cur->SUBJ_DESCRIPTION  : 'Description' ;?><br/>
			     	<!--	<td><?php //echo (isset($cur)) ? $cur->SEMESTER : 'Semester' ;?></td>-->
			     		<strong>Grado y Seccion:</strong> <?php echo (isset($cur)) ? $cur->COURSE_DESC : 'Course' ;?><br/>
			     	<!--	<td><?php //echo (isset($cur)) ? $cur->COURSE_LEVEL : 'Level' ;?></td>-->
			     		
			     		<strong>Dias y Tiempo:</strong> <?php echo (isset($cur)) ? $cur->DAY . ' ' .$cur->C_TIME : 'DaysTime' ;?><br/>
			     	<strong>Aula:</strong> <?php echo (isset($cur)) ? $cur->ROOM : 'Room' ;?><br/>
			     	<strong>Seccion:</strong> <?php echo (isset($cur)) ? $cur->SECTION : 'Room' ;?></td>
	...
	?>
		<div class="wellss">
			<h3 align="left">Lista de estudiantes</h3>
				...
				<div class="btn-group">
				  <a href="index.php?view=instSubj&instructorId=<?php echo $_GET['instructorId'];?>" class="btn btn-default">Regresar</a>

		<div class="well">
			<h3 align="left">Lista de asignaturas</h3>
				...
				<div class="btn-group">
				  <a href="index.php?view=instSubj&instructorId=<?php echo (isset($instructorId)) ? $instructorId : 'ID' ;?>" class="btn btn-default"><span class="glyphicon glyphicon-back"></span>Regresar</a>

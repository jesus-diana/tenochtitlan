      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">La Gran Tenochtitlan</a>
          </div>
       ...
       <!--        <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <?php } ?>
                  <a class="dropdown-item" href="<?php echo WEB_ROOT; ?>admin/logout.php">Salir</a>
                </div>
              </li> 
            </ul>
          </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright" id="copyright">
            ...
            </script>, Creado Por Jesus Roman || Diana Araujo

            ...
            <div class="col-10 col-sm-10 col-lg-10">
					...
					<div class="panel panel-primary">
					  ...
					  <div class="panel-body">
					    ...
					    <table>
					    	...
					    	<table>
					<caption><h3 align="left">Consejo de materias</h3></caption>
				  <thead>
				  	<tr id="table">
				  		<th width="20%" class="bottom" align="left">Codigo de asignatura</th>
				  		<th width="30%" class="bottom" align="left">Descripcion</th>
				  		<th width="10%" class="bottom" align="left">Semestre</th>
				 		<th width="10%" class="bottom" align="left">Curso</th>
				 		<th width="10%" class="bottom" align="left">Nivel</th>
				 		<th width="10%" class="bottom" align="left">Pre-requisito</th>
				  ...
				  <tfoot>
					...
					$mydb->setQuery("SELECT SUM(UNIT) as UN
				  	...
				  	<tr><td colspan="2">Fecha impresa:  <? print(Date("l F d, Y")); ?></td><td  colspan="4" align="Right"><Strong>Total</Strong></td><td align="center" ><strong><?php echo $result->UN; ?></strong></td></tr>
				  	<tr><td  colspan="7"></td></tr>
				  	<tr><td colspan="2"></td><td colspan="2">Aconsejado y imformado por:</td><td ></td></tr>
				  </tfoot>	
				</table>

      ...
      <div class="ftco-cover-1 overlay" style="background-image: url('images/fondo.jpg')">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-5">
              <h1 class="line-bottom">La Gran Tenochtitlan</h1>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 pr-md-5 mr-auto">
            <h2 class="line-bottom">Salir</h2>
            <p>Area para perfil de estudiante</p>
          </div>
          <div class="col-md-6">
            <div class="quick-contact-form bg-white">
                <h2>Login Informacion</h2>
                <hr/>
               ...
               <hr/>
                ...
                <a href="logout.php" class="btn btn-primary px-5">Salir<span class="fa fa-log-out"></span></a>
              </div>
              </div>
          </div>
        </div>

            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation  ml-auto d-none d-lg-block " role="navigation"  style="color: red" >
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="<?php echo WEB_ROOT; ?>">Incio</a></li>
                  <li><a href="<?php echo WEB_ROOT; ?>index.php?page=3">Tus Calificaciones</a></li>
          
                  <li><a href="<?php echo WEB_ROOT; ?>logout.php">Salir</a></li>  
                </ul>
              </nav>
            </div>
      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados  | hecho <i class="icon-heart text-danger" aria-hidden="true"></i> por Jesus Roman || Diana Araujo </a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
          </div>
